...
$student_details = [
    [
        ...
        'education' => ['PSC', 'JSC', 'SSC', 'HSC'],
        'friends' => ['Bappy', 'Shuvo', 'Mahdi'],
    ],
    [
        'name' => 'Siam',
        'age' => 15,
        ...
        <div class="col-md-6 ">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php
                            if (is_array($student)) // execute if $student is an array
                            {
                                echo $key;
                                echo "<ul>";
